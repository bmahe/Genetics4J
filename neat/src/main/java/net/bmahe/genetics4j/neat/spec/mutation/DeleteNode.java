...
@Value.Immutable
public abstract class DeleteNode implements MutationPolicy {
	 ...
	 */
	public static DeleteNode of(final double populationMutationProbability) {
		return ImmutableDeleteNode.of(populationMutationProbability);
	}
