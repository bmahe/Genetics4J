...
public class NeatSwitchStatePolicyHandler<T extends Comparable<T>> implements MutationPolicyHandler<T> {

	private final RandomGenerator randomGenerator;

	public NeatSwitchStatePolicyHandler(final RandomGenerator _randomGenerator) {
	...
	@Override
	public boolean canHandle(MutationPolicyHandlerResolver<T> mutationPolicyHandlerResolver,
			MutationPolicy mutationPolicy) {
		Validate.notNull(mutationPolicy);

		return mutationPolicy instanceof SwitchStateMutation;
	}
	...
	public Mutator createMutator(final AbstractEAExecutionContext<T> eaExecutionContext,
		...
		final SwitchStateMutation switchStateMutationPolicy = (SwitchStateMutation) mutationPolicy;
		final double populationMutationProbability = switchStateMutationPolicy.populationMutationProbability();
