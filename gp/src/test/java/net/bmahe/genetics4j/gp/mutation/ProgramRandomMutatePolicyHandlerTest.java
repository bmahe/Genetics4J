...
public class ProgramRandomMutatePolicyHandlerTest {
	...
	public void noRandomCtorArguments() {
		new ProgramRandomMutatePolicyHandler(null, new StdProgramGenerator(new Random()));
	}
	...
	public void createMutator() {
		...
		final Mutator mutator = programRandomMutatePolicyHandler.createMutator(mockGeneticSystemDescriptor,
				mockGenotypeSpec,
