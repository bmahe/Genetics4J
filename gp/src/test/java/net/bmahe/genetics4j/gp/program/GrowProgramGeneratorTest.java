...
public class GrowProgramGeneratorTest {

	@Test(expected = NullPointerException.class)
	public void checkNoParamCtor() {
		final GrowProgramGenerator programGenerator = new GrowProgramGenerator(null);
	}
	...
	public void generate() {
		...
		final GrowProgramGenerator programGenerator = new GrowProgramGenerator(programHelper);
