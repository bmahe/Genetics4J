...
public class ProgramRandomPruneMutatorTest {
	...
	public void noMutate() {
		...
		final ProgramRandomPruneMutator programRandomPruneMutator = new ProgramRandomPruneMutator(programGenerator,
	...
	public void simple() {
		...
		assertEquals(2,
				duplicateAndCut.getChildren()
						.size());
		assertEquals(PINode.getData(),
				duplicateAndCut.getChild(0)
						.getData());
		assertNotEquals(nodeStrToDouble.getData(),
				duplicateAndCut.getChild(1)
						.getData());
